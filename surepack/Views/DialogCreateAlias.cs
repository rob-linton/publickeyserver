...
public class DialogCreateAlias
{
	...
	public void Build()
	{
		...
		serverInfo.Text = "For instructions for setting up your own SureDrop server contact Senetas";
		...
		getDomain.Clicked += async () => {
			...
			try
			{
				...
				if (application == "suredrop")
				{
					string output = "SureDrop server found. Version: " + s.Version??"0.0.0";
				...
				{
					progressLabel.Text = "SureDrop server not found.";
