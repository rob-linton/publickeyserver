...
public class Program
{
	public static async Task<int> ParseOptions(string[] args)
	{
		...
		var opts = Parser.Default.ParseArguments<Options, PackOptions, UnpackOptions, CreateOptions, CertifyOptions, ListOptions, SendOptions, ReceiveOptions, VerifyOptions>(args);
